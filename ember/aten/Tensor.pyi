...
class GradTensor(BaseTensor):
    ...
    @overload
    def add(self, other: 'ScalarTensor') -> 'Tensor': ... 
    @overload
    def add(self, other: 'GradTensor') -> 'GradTensor': ... 
    @overload
    def add(self, other: 'Tensor') -> 'Tensor': ... 
    @overload
    def add(self, other: float) -> 'Tensor': ... 

    @overload
    def sub(self, other: 'ScalarTensor') -> 'Tensor': ... 
    @overload
    def sub(self, other: 'GradTensor') -> 'GradTensor': ... 
    @overload
    ...
    @overload
    def mul(self, other: 'ScalarTensor') -> 'Tensor': ... 
    @overload
    def mul(self, other: 'GradTensor') -> 'GradTensor': ... 
    @overload
